        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link href="/lookbook" className="hover:text-orange-500">
                  Lookbook
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/policy/shipping" className="hover:text-orange-500">
                  Chính sách giao hàng
                </Link>
              </li>
              <li>
                <Link href="/policy/return" className="hover:text-orange-500">
                  Chính sách đổi trả
                </Link>
              </li>
              <li>
                <Link href="/policy/privacy" className="hover:text-orange-500">
                  Chính sách bảo mật
                </Link>
              </li>
              <li>
