...
function getFlashSaleEndTime() {
  const saved = safeLocalStorage.getItem("flashSaleEndTime");
  if (saved) {
  ...
  safeLocalStorage.setItem("flashSaleEndTime", endTime.toISOString());
  return endTime;
}
...
export function HomePage() {
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      ...
      if (diff <= 0) {
        // Reset timer
        safeLocalStorage.removeItem("flashSaleEndTime");
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/products?sort=bestseller" className="text-orange-500 hover:text-orange-600 flex items-center gap-2">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/products?sort=newest" className="text-orange-500 hover:text-orange-600 flex items-center gap-2">
              Xem tất cả <ChevronRight className="w-5 h-5" />
            </Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Link href="/lookbook" key={item.title} className="relative aspect-[3/4] rounded-lg overflow-hidden group">
