        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                <img src="https://www.google.com/favicon.ico" alt="Google" className="w-5 h-5" onError={(e) => { (e.target as any).style.display = 'none'; }} />
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border rounded-lg hover:bg-gray-50 transition-colors opacity-75"
              >
                <img src="https://www.facebook.com/favicon.ico" alt="Facebook" className="w-5 h-5" onError={(e) => { (e.target as any).style.display = 'none'; }} />
